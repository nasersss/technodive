...
{
    newElement.innerHTML = `<tr class="tr_data inputs-border-radius-0">
    <td>
    ...
    <td>
        <input name="recipientName[]" type="text" class="form-control inputRead recipientName"
        id="validationCustom06" placeholder="ادخل المستلم.." required="">
    </td>
    <td>
 ...
 function deleteTage(tageIndex)
    {
        if (types[tageIndex].options.selectedIndex === 0 || senderName[tageIndex].options.selectedIndex === 0) {
            ...
            recipientName[tageIndex].removeAttribute('name')
            ...
            recipientName[tageIndex].classList.remove('inputRead')
            ...
            recipientName[tageIndex].value ="0";
            ...
            recipientName[tageIndex].removeAttribute('required')
