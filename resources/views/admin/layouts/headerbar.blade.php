                    ...
                    <ul class="navbar-nav header-right">
                        ...
                        <li class="nav-item dropdown notification_dropdown">
                            <a class="nav-link  ai-icon" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                ...
                                {{-- @isset(Auth::user()->countNotIsSeen()) --}}
                                @if(count(Auth::user()->countNotIsSeen()) > 0)
                                <span class="badge light text-white bg-primary rounded-circle">  {{count(Auth::user()->notificationTo)}} </span>
                                @endif
                                {{-- @endisset --}}
                            </a>
                            <div class="dropdown-menu dropdown-menu-end">
                                <div id="dlab_W_Notification1" class="widget-media dlab-scroll p-3" style="height:380px;">
                                    <span class="mb-5">الإشعارات</span>
                                        ...
                                        <li>
                                            <div class="timeline-panel">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="mb-1">{{ $notification->fromUser->name }}</h6>
                                                    <p style="padding-right: 46px;" class="text-muted mb-0 user-msg">
                                                        <small>{{$notification->content}}</small>
                                                    </p>

                                                    <small class="d-block">@isset($notification->created_at) {{$notification->created_at}} @endisset</small>
                                                </div>
                                            </div>
                                        </li>
                                        </a>
                                ...
                                <a class="all-notification" href="javascript:void(0);">اطلع على جميع الإشعارات <i class="ti-arrow-end"></i></a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            {{-- <a href="javascript:void(0);" class="btn btn-primary d-sm-inline-block d-none"><i class="las la-signal ms-3 scale5"></i>انشاء تقرير</a> --}}
                        </li>
                    </ul>
                </div>
            </nav>
