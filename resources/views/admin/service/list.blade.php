...
@section('content-body')
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex flex-wrap align-items-center mb-3">
            <button type="button" class="btn btn-primary  me-1 add-item" data-route="{{ route('service_store') }}"
                data-method="POST" data-modal_title='إضافة خدمة جديدة'>
                                ...
                                @isset($services)
                                    @foreach ($services as $service)
                                        <tr class="odd" role="row">
                                            ...
                                            <td>
                                                <img src="{{ asset('storage/images/' . $service->image) }}" width="200px"
                                                    alt="">
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="dropdown dropstart">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <button type="button" data-route="{{ route('service_update') }}"
                                                            data-method="POST" data-modal_title='تحديث الخدمة '
                                                        ...
                                                        <button type="button" value="" data-id="{{ $service->id }}"
                                                            data-is_active="{{ $service->is_active }}" data-title="الخدمة"
