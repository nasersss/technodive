...
@section('content-body')
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex flex-wrap align-items-center mb-3">
            ...
            <button type="button" class="btn btn-primary  me-1 add-item" data-route="{{ route('work_store') }}"
                data-method="POST" data-modal_title='إضافة عمل جديدة'>
                                            ...
                                            <td>
                                                <div class="dropdown dropstart">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <button type="button" data-route="{{ route('work_update') }}"
                                                            data-method="POST" data-modal_title='تحديث العمل '
                                                        ...
                                                        <button type="button" value="" data-id="{{ $work->id }}"
                                                            data-is_active="{{ $work->is_active }}" data-title="العمل"
