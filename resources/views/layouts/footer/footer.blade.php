    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt ms-3"></i>اليمن -حضرموت - المكلا</p>
                <p class="mb-2"><i class="fa fa-phone-alt ms-3"></i>+967 733899087 |  +967 777375652</p>
                <p class="mb-2"><i class="fa fa-envelope ms-3"></i>saeed78ba@yahoo.com</p>
                <div class="d-flex pt-2">
                    <a class="btn btn-square btn-outline-secondary rounded-circle ms-1" href=""><i class="fab fa-twitter"></i></a>
                    ...
                    <a class="btn btn-square btn-outline-secondary rounded-circle ms-0" href=""><i class="fab fa-linkedin-in"></i></a>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-center text-md-start">
                   ...
                   تصميم<a href="https://htmlcodex.com" >  مجموعة قوأب لتطوير البرمجيات </a>
                </div>
            </div>
        </div>
    </div>
